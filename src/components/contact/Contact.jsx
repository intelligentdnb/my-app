        ...
        <div className='contact-container'>
            ...
            <div className='socials-container'>
                <ul>
                    ...
                    <li><a href='https://www.linkedin.com/in/juandimca/' target="__BLANK">linkedln</a></li>
                    <br/>
                    <br/>
                    <p>email</p>
                    ...
                    <li><a href='' className='cvs' dowload>dowload in spanish</a></li>
                    <li><a href='' className='cvs' dowload>dowload in english</a></li>
                </ul>
            </div>
            <Footer />
        </div>
